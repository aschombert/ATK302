...
var pass;
var homepage;
let rad = 600; // Width of the shape
...
function draw() {
  ...
  switch (myState) {
    ...
    image(homepage, width/2, height/2, 600,600);
    ...
    case 14:
      ...
      case 15:
      background(51, 204, 255);
      image(lose, width/2, height/2, 600,600);
